...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col relative overflow-hidden bg-gradient-to-b from-slate-800 via-slate-700 to-slate-600">
      {/* Stars Background */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/3 right-1/6 w-1 h-1 bg-rose-200 rounded-full animate-pulse delay-300"></div>
        ...
        <div className="absolute top-2/3 right-1/5 w-0.5 h-0.5 bg-teal-200 rounded-full animate-pulse delay-400"></div>
        <div className="absolute top-1/2 left-1/5 w-1.5 h-1.5 bg-emerald-200 rounded-full animate-pulse delay-600"></div>
      ...
      <div 
        className={`flex-1 bg-gradient-to-b from-rose-400/25 via-red-400/30 to-orange-400/35 flex items-center justify-center cursor-pointer transition-all duration-300 backdrop-blur-sm ${
      ...
      <div 
        className={`flex-1 bg-gradient-to-t from-teal-400/25 via-cyan-500/30 to-emerald-500/35 flex items-center justify-center cursor-pointer transition-all duration-300 backdrop-blur-sm ${
